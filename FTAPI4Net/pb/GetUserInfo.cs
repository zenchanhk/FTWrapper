...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class GetUserInfo {
    ...
    static GetUserInfo() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "byIZCgNDMlMSEgoEZmxhZxgCIAEoBVIEZmxhZyKfAwoDUzJDEhoKCG5pY2tO", 
            ...
            "T3B0aW9uUW90UmlnaHQYDCABKAhSE2hhc1VTT3B0aW9uUW90UmlnaHQiLQoH", 
            "UmVxdWVzdBIiCgNjMnMYASACKAsyEC5HZXRVc2VySW5mby5DMlNSA2MycyKA", 
            "AQoIUmVzcG9uc2USHgoHcmV0VHlwZRgBIAIoBToELTQwMFIHcmV0VHlwZRIW", 
            "CgZyZXRNc2cYAiABKAlSBnJldE1zZxIYCgdlcnJDb2RlGAMgASgFUgdlcnJD", 
            "b2RlEiIKA3MyYxgEIAEoCzIQLkdldFVzZXJJbmZvLlMyQ1IDczJjKk4KClVw", 
            "ZGF0ZVR5cGUSEwoPVXBkYXRlVHlwZV9Ob25lEAASFQoRVXBkYXRlVHlwZV9B", 
            "ZHZpY2UQARIUChBVcGRhdGVUeXBlX0ZvcmNlEAIqrgEKDVVzZXJJbmZvRmll", 
            "bGQSFwoTVXNlckluZm9GaWVsZF9CYXNpYxABEhUKEVVzZXJJbmZvRmllbGRf", 
            "QVBJEAISGgoWVXNlckluZm9GaWVsZF9Rb3RSaWdodBAEEhwKGFVzZXJJbmZv", 
            "RmllbGRfRGlzY2xhaW1lchAIEhgKFFVzZXJJbmZvRmllbGRfVXBkYXRlEBAS", 
            "GQoUVXNlckluZm9GaWVsZF9XZWJLZXkQgBBCFQoTY29tLmZ1dHUub3BlbmFw", 
          "aS5wYg=="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_GetUserInfo_S2C__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.GetUserInfo.S2C, global::Futu.OpenApi.Pb.GetUserInfo.S2C.Builder>(internal__static_GetUserInfo_S2C__Descriptor,
                new string[] { "NickName", "AvatarUrl", "ApiLevel", "HkQotRight", "UsQotRight", "CnQotRight", "IsNeedAgreeDisclaimer", "UserID", "UpdateType", "WebKey", "HkOptionQotRight", "HasUSOptionQotRight", });
    ...
    public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
      ...
      private static readonly string[] _s2CFieldNames = new string[] { "apiLevel", "avatarUrl", "cnQotRight", "hasUSOptionQotRight", "hkOptionQotRight", "hkQotRight", "isNeedAgreeDisclaimer", "nickName", "updateType", "usQotRight", "userID", "webKey" };
      private static readonly uint[] _s2CFieldTags = new uint[] { 26, 18, 48, 96, 88, 32, 56, 10, 72, 40, 64, 82 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasNickName) {
          output.WriteString(1, field_names[7], NickName);
        }
        if (hasAvatarUrl) {
        ...
        if (hasHkQotRight) {
          output.WriteInt32(4, field_names[5], HkQotRight);
        }
        if (hasUsQotRight) {
          output.WriteInt32(5, field_names[9], UsQotRight);
        }
        if (hasCnQotRight) {
          output.WriteInt32(6, field_names[2], CnQotRight);
        }
        if (hasIsNeedAgreeDisclaimer) {
          output.WriteBool(7, field_names[6], IsNeedAgreeDisclaimer);
        }
        if (hasUserID) {
          output.WriteInt64(8, field_names[10], UserID);
        }
        if (hasUpdateType) {
          output.WriteInt32(9, field_names[8], UpdateType);
        }
        if (hasWebKey) {
          output.WriteString(10, field_names[11], WebKey);
        }
        if (hasHkOptionQotRight) {
          output.WriteInt32(11, field_names[4], HkOptionQotRight);
        }
