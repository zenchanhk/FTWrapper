...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class QotGetOptionChain {
    ...
    static QotGetOptionChain() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bhoMQ29tbW9uLnByb3RvGhBRb3RfQ29tbW9uLnByb3RvIsUBCgNDMlMSKgoF", 
            "b3duZXIYASACKAsyFC5Rb3RfQ29tbW9uLlNlY3VyaXR5UgVvd25lchIoCg9p", 
            "bmRleE9wdGlvblR5cGUYBiABKAVSD2luZGV4T3B0aW9uVHlwZRISCgR0eXBl", 
            "GAIgASgFUgR0eXBlEhwKCWNvbmRpdGlvbhgDIAEoBVIJY29uZGl0aW9uEhwK", 
            "CWJlZ2luVGltZRgEIAIoCVIJYmVnaW5UaW1lEhgKB2VuZFRpbWUYBSACKAlS", 
            "B2VuZFRpbWUicgoKT3B0aW9uSXRlbRIyCgRjYWxsGAEgASgLMh4uUW90X0Nv", 
            "bW1vbi5TZWN1cml0eVN0YXRpY0luZm9SBGNhbGwSMAoDcHV0GAIgASgLMh4u", 
            "UW90X0NvbW1vbi5TZWN1cml0eVN0YXRpY0luZm9SA3B1dCKPAQoLT3B0aW9u", 
            "Q2hhaW4SHgoKc3RyaWtlVGltZRgBIAIoCVIKc3RyaWtlVGltZRI2CgZvcHRp", 
            "b24YAiADKAsyHi5Rb3RfR2V0T3B0aW9uQ2hhaW4uT3B0aW9uSXRlbVIGb3B0", 
            "aW9uEigKD3N0cmlrZVRpbWVzdGFtcBgDIAEoAVIPc3RyaWtlVGltZXN0YW1w", 
            "IkgKA1MyQxJBCgtvcHRpb25DaGFpbhgBIAMoCzIfLlFvdF9HZXRPcHRpb25D", 
            "aGFpbi5PcHRpb25DaGFpblILb3B0aW9uQ2hhaW4iNAoHUmVxdWVzdBIpCgNj", 
            "MnMYASACKAsyFy5Rb3RfR2V0T3B0aW9uQ2hhaW4uQzJTUgNjMnMihwEKCFJl", 
            "c3BvbnNlEh4KB3JldFR5cGUYASACKAU6BC00MDBSB3JldFR5cGUSFgoGcmV0", 
            "TXNnGAIgASgJUgZyZXRNc2cSGAoHZXJyQ29kZRgDIAEoBVIHZXJyQ29kZRIp", 
            "CgNzMmMYBCABKAsyFy5Rb3RfR2V0T3B0aW9uQ2hhaW4uUzJDUgNzMmMqYgoO", 
            "T3B0aW9uQ29uZFR5cGUSGQoVT3B0aW9uQ29uZFR5cGVfVW5rbm93EAASGQoV", 
            "T3B0aW9uQ29uZFR5cGVfV2l0aEluEAESGgoWT3B0aW9uQ29uZFR5cGVfT3V0", 
          "c2lkZRACQhUKE2NvbS5mdXR1Lm9wZW5hcGkucGI="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Qot_GetOptionChain_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotGetOptionChain.C2S, global::Futu.OpenApi.Pb.QotGetOptionChain.C2S.Builder>(internal__static_Qot_GetOptionChain_C2S__Descriptor,
                new string[] { "Owner", "IndexOptionType", "Type", "Condition", "BeginTime", "EndTime", });
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "beginTime", "condition", "endTime", "indexOptionType", "owner", "type" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 34, 24, 42, 48, 10, 16 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasOwner) {
          output.WriteMessage(1, field_names[4], Owner);
        }
        if (hasType) {
        ...
        if (hasIndexOptionType) {
          output.WriteInt32(6, field_names[3], IndexOptionType);
        }
