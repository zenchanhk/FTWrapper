...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class QotGetSecuritySnapshot {
    ...
    static QotGetSecuritySnapshot() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "UgplcXVhbENvdW50IrsLChFTbmFwc2hvdEJhc2ljRGF0YRIwCghzZWN1cml0", 
            "eRgBIAIoCzIULlFvdF9Db21tb24uU2VjdXJpdHlSCHNlY3VyaXR5EhIKBHR5", 
            "cGUYAiACKAVSBHR5cGUSHAoJaXNTdXNwZW5kGAMgAigIUglpc1N1c3BlbmQS", 
            "GgoIbGlzdFRpbWUYBCACKAlSCGxpc3RUaW1lEhgKB2xvdFNpemUYBSACKAVS", 
            "B2xvdFNpemUSIAoLcHJpY2VTcHJlYWQYBiACKAFSC3ByaWNlU3ByZWFkEh4K", 
            "CnVwZGF0ZVRpbWUYByACKAlSCnVwZGF0ZVRpbWUSHAoJaGlnaFByaWNlGAgg", 
            "AigBUgloaWdoUHJpY2USHAoJb3BlblByaWNlGAkgAigBUglvcGVuUHJpY2US", 
            "GgoIbG93UHJpY2UYCiACKAFSCGxvd1ByaWNlEiYKDmxhc3RDbG9zZVByaWNl", 
            "GAsgAigBUg5sYXN0Q2xvc2VQcmljZRIaCghjdXJQcmljZRgMIAIoAVIIY3Vy", 
            "UHJpY2USFgoGdm9sdW1lGA0gAigDUgZ2b2x1bWUSGgoIdHVybm92ZXIYDiAC", 
            "KAFSCHR1cm5vdmVyEiIKDHR1cm5vdmVyUmF0ZRgPIAIoAVIMdHVybm92ZXJS", 
            "YXRlEiQKDWxpc3RUaW1lc3RhbXAYECABKAFSDWxpc3RUaW1lc3RhbXASKAoP", 
            "dXBkYXRlVGltZXN0YW1wGBEgASgBUg91cGRhdGVUaW1lc3RhbXASGgoIYXNr", 
            "UHJpY2UYEiABKAFSCGFza1ByaWNlEhoKCGJpZFByaWNlGBMgASgBUghiaWRQ", 
            "cmljZRIWCgZhc2tWb2wYFCABKANSBmFza1ZvbBIWCgZiaWRWb2wYFSABKANS", 
            "BmJpZFZvbBIiCgxlbmFibGVNYXJnaW4YFiABKAhSDGVuYWJsZU1hcmdpbhIk", 
            "Cg1tb3J0Z2FnZVJhdGlvGBcgASgBUg1tb3J0Z2FnZVJhdGlvEjYKFmxvbmdN", 
            "YXJnaW5Jbml0aWFsUmF0aW8YGCABKAFSFmxvbmdNYXJnaW5Jbml0aWFsUmF0", 
            "aW8SKAoPZW5hYmxlU2hvcnRTZWxsGBkgASgIUg9lbmFibGVTaG9ydFNlbGwS", 
            "JAoNc2hvcnRTZWxsUmF0ZRgaIAEoAVINc2hvcnRTZWxsUmF0ZRIyChRzaG9y", 
            "dEF2YWlsYWJsZVZvbHVtZRgbIAEoA1IUc2hvcnRBdmFpbGFibGVWb2x1bWUS", 
            "OAoXc2hvcnRNYXJnaW5Jbml0aWFsUmF0aW8YHCABKAFSF3Nob3J0TWFyZ2lu", 
            "SW5pdGlhbFJhdGlvEhwKCWFtcGxpdHVkZRgdIAEoAVIJYW1wbGl0dWRlEhoK", 
            "CGF2Z1ByaWNlGB4gASgBUghhdmdQcmljZRIgCgtiaWRBc2tSYXRpbxgfIAEo", 
            "AVILYmlkQXNrUmF0aW8SIAoLdm9sdW1lUmF0aW8YICABKAFSC3ZvbHVtZVJh", 
            "dGlvEjAKE2hpZ2hlc3Q1MldlZWtzUHJpY2UYISABKAFSE2hpZ2hlc3Q1Mldl", 
            "ZWtzUHJpY2USLgoSbG93ZXN0NTJXZWVrc1ByaWNlGCIgASgBUhJsb3dlc3Q1", 
            "MldlZWtzUHJpY2USMAoTaGlnaGVzdEhpc3RvcnlQcmljZRgjIAEoAVITaGln", 
            "aGVzdEhpc3RvcnlQcmljZRIuChJsb3dlc3RIaXN0b3J5UHJpY2UYJCABKAFS", 
            "Emxvd2VzdEhpc3RvcnlQcmljZRI8CglwcmVNYXJrZXQYJSABKAsyHi5Rb3Rf", 
            "Q29tbW9uLlByZUFmdGVyTWFya2V0RGF0YVIJcHJlTWFya2V0EkAKC2FmdGVy", 
            "TWFya2V0GCYgASgLMh4uUW90X0NvbW1vbi5QcmVBZnRlck1hcmtldERhdGFS", 
            "C2FmdGVyTWFya2V0EhwKCXNlY1N0YXR1cxgnIAEoBVIJc2VjU3RhdHVzIugD", 
            "CghTbmFwc2hvdBJACgViYXNpYxgBIAIoCzIqLlFvdF9HZXRTZWN1cml0eVNu", 
            "YXBzaG90LlNuYXBzaG90QmFzaWNEYXRhUgViYXNpYxJRCgxlcXVpdHlFeERh", 
            "dGEYAiABKAsyLS5Rb3RfR2V0U2VjdXJpdHlTbmFwc2hvdC5FcXVpdHlTbmFw", 
            "c2hvdEV4RGF0YVIMZXF1aXR5RXhEYXRhElQKDXdhcnJhbnRFeERhdGEYAyAB", 
            "KAsyLi5Rb3RfR2V0U2VjdXJpdHlTbmFwc2hvdC5XYXJyYW50U25hcHNob3RF", 
            "eERhdGFSDXdhcnJhbnRFeERhdGESUQoMb3B0aW9uRXhEYXRhGAQgASgLMi0u", 
            "UW90X0dldFNlY3VyaXR5U25hcHNob3QuT3B0aW9uU25hcHNob3RFeERhdGFS", 
            "DG9wdGlvbkV4RGF0YRJOCgtpbmRleEV4RGF0YRgFIAEoCzIsLlFvdF9HZXRT", 
            "ZWN1cml0eVNuYXBzaG90LkluZGV4U25hcHNob3RFeERhdGFSC2luZGV4RXhE", 
            "YXRhEk4KC3BsYXRlRXhEYXRhGAYgASgLMiwuUW90X0dldFNlY3VyaXR5U25h", 
            "cHNob3QuUGxhdGVTbmFwc2hvdEV4RGF0YVILcGxhdGVFeERhdGEiTAoDUzJD", 
            "EkUKDHNuYXBzaG90TGlzdBgBIAMoCzIhLlFvdF9HZXRTZWN1cml0eVNuYXBz", 
            "aG90LlNuYXBzaG90UgxzbmFwc2hvdExpc3QiOQoHUmVxdWVzdBIuCgNjMnMY", 
            "ASACKAsyHC5Rb3RfR2V0U2VjdXJpdHlTbmFwc2hvdC5DMlNSA2MycyKMAQoI", 
            "UmVzcG9uc2USHgoHcmV0VHlwZRgBIAIoBToELTQwMFIHcmV0VHlwZRIWCgZy", 
            "ZXRNc2cYAiABKAlSBnJldE1zZxIYCgdlcnJDb2RlGAMgASgFUgdlcnJDb2Rl", 
            "Ei4KA3MyYxgEIAEoCzIcLlFvdF9HZXRTZWN1cml0eVNuYXBzaG90LlMyQ1ID", 
          "czJjQhUKE2NvbS5mdXR1Lm9wZW5hcGkucGI="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Qot_GetSecuritySnapshot_PlateSnapshotExData__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotGetSecuritySnapshot.PlateSnapshotExData, global::Futu.OpenApi.Pb.QotGetSecuritySnapshot.PlateSnapshotExData.Builder>(internal__static_Qot_GetSecuritySnapshot_PlateSnapshotExData__Descriptor,
                new string[] { "RaiseCount", "FallCount", "EqualCount", });
        internal__static_Qot_GetSecuritySnapshot_SnapshotBasicData__Descriptor = Descriptor.MessageTypes[6];
        ...
        internal__static_Qot_GetSecuritySnapshot_Snapshot__Descriptor = Descriptor.MessageTypes[7];
        ...
        internal__static_Qot_GetSecuritySnapshot_S2C__Descriptor = Descriptor.MessageTypes[8];
        ...
        internal__static_Qot_GetSecuritySnapshot_Request__Descriptor = Descriptor.MessageTypes[9];
        internal__static_Qot_GetSecuritySnapshot_Request__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotGetSecuritySnapshot.Request, global::Futu.OpenApi.Pb.QotGetSecuritySnapshot.Request.Builder>(internal__static_Qot_GetSecuritySnapshot_Request__Descriptor,
                new string[] { "C2S", });
        internal__static_Qot_GetSecuritySnapshot_Response__Descriptor = Descriptor.MessageTypes[10];
    ...
    public sealed partial class SnapshotBasicData : pb::GeneratedMessage<SnapshotBasicData, SnapshotBasicData.Builder> {
      ...
      private static readonly uint[] _snapshotBasicDataFieldTags = new uint[] { 306, 233, 145, 160, 241, 249, 153, 168, 97, 176, 200, 65, 265, 281, 24, 89, 34, 129, 193, 40, 81, 273, 289, 185, 73, 298, 49, 312, 10, 216, 225, 209, 113, 121, 16, 58, 137, 104, 257 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasSecurity) {
          output.WriteMessage(1, field_names[28], Security);
        }
        if (hasType) {
          output.WriteInt32(2, field_names[34], Type);
        }
        if (hasIsSuspend) {
        ...
        if (hasUpdateTime) {
          output.WriteString(7, field_names[35], UpdateTime);
        }
        if (hasHighPrice) {
        ...
        if (hasVolume) {
          output.WriteInt64(13, field_names[37], Volume);
        }
        if (hasTurnover) {
          output.WriteDouble(14, field_names[32], Turnover);
        }
        if (hasTurnoverRate) {
          output.WriteDouble(15, field_names[33], TurnoverRate);
        }
        if (hasListTimestamp) {
          output.WriteDouble(16, field_names[17], ListTimestamp);
        }
        if (hasUpdateTimestamp) {
          output.WriteDouble(17, field_names[36], UpdateTimestamp);
        }
        if (hasAskPrice) {
        ...
        if (hasShortSellRate) {
          output.WriteDouble(26, field_names[31], ShortSellRate);
        }
        if (hasShortAvailableVolume) {
          output.WriteInt64(27, field_names[29], ShortAvailableVolume);
        }
        if (hasShortMarginInitialRatio) {
          output.WriteDouble(28, field_names[30], ShortMarginInitialRatio);
        }
        if (hasAmplitude) {
        ...
        if (hasVolumeRatio) {
          output.WriteDouble(32, field_names[38], VolumeRatio);
        }
        ...
        if (hasSecStatus) {
          output.WriteInt32(39, field_names[27], SecStatus);
        }
        UnknownFields.WriteTo(output);
      }
